...
namespace Bing.Samples.Modules
{
    ...
    public class MysqlModule : AspNetCoreBingModule
    {
        /// <summary>
        /// 模块级别。级别越小越先启动
        /// </summary>
        ...
        {
            // 注册工作单元
            services.AddSqlServerUnitOfWork<ISampleUnitOfWork, Bing.Samples.Data.UnitOfWorks.MySql.SampleUnitOfWork>(
        ...
        public override void UseModule(IApplicationBuilder app) => Enabled = false;
    }
}
